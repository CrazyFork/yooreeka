...
// Checkout booknotes for more information about MST.
// then come back reading this code
...
public class MST {
    ...
    public double[][] buildMST(double[][] adjM) {
        ...
        boolean[] allV = new boolean[adjM.length];// all verticles. namely all unique elements
        allV[0] = true;
        ...
        while((e = findMinimumEdge(allV)) != null ) {
            allV[e.getJ()] = true; // set the signal that this element already been setted
